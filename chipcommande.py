...
global boutons
factory = PiGPIOFactory(host='192.168.0.44') #remote device local IP address
coffrage=[]
pieds=[]
...
class MQTTb:
    ...
    def __init__(self):
        ...
        self.client.connect(host='192.168.0.13',port=1883) #Host's IP address
...
clfu=bouton('lfu',17,'192.168.1.44','coffrage','up') #Left Front Up
